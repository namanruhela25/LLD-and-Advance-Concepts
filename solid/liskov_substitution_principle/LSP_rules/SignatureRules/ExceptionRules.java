...
class Child extends Parent {
    ...
    public void getValue() throws ArithmeticException {
        ...
        //throw new Exception("Child error"); // This is wrong & not allowed because parent is throwring RunTimeException and child is throwing Exception which is broader than RuntimeException
    }
}
...
public class ExceptionRules {
    public static void main(String[] args) {
        ...
        // Both clild and parent throw Run time Exeception 
